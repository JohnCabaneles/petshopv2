...
<div class="p-10">
    <p class="text-lg font-bold uppercase">Foods / Treats</p>
</div>
        ...
        <div class="">
            @if ($products->isEmpty())
                <div class="flex justify-center">
                    <p class="p-5 text-xl font-semibold text-gray-700 rounded-lg bg-slate-300 ">No products available</p>
                </div>
            @else
                        ...
                        @foreach ($products as $product)
                            <div class="flex flex-col max-w-xs p-5 overflow-hidden rounded-lg shadow-md bg-slate-300">
                                ...
                                <div class="flex gap-2">
                                    <button class="flex items-center justify-center flex-1 gap-1 px-4 py-2 text-gray-800 bg-blue-500 rounded-lg shadow-xl hover:bg-blue-600 hover:text-white">
                                        Buy now
                                    </button>
